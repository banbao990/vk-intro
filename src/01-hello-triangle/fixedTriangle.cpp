...
FixedTriangleApp::FixedTriangleApp(const char *name, uint32_t width, uint32_t height,
...
void FixedTriangleApp::init_pipeline() {
    ...
    add_pipeline_no_input("01-tri-fixed.vert.spv", "01-tri-fixed.frag.spv", nullptr, 0, false,
