...
public:
    RasApp(const char *name, uint32_t width, uint32_t height, bool use_validation_layer)
        : App(name, width, height, use_validation_layer) {}
...
protected:
    ...
    void add_pipeline_no_input(const char *vertex_shader_relative_path,
