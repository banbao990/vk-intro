...
void RasTexApp::upload_texture(Material &material) {
    ...
    AllocatedBuffer staging_buffer =
        create_buffer(image_size, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, VMA_MEMORY_USAGE_CPU_ONLY);
    ...
    // create VkImage
    VkExtent3D image_extent = {static_cast<uint32_t>(material._width),
                               static_cast<uint32_t>(material._height), 1};
