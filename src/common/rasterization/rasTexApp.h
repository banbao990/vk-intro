...
public:
    RasTexApp(const char *name, uint32_t width, uint32_t height, bool use_validation_layer)
...
protected:
    ...
    // VkDescriptorSetLayout* set_layout, uint32_t set_layout_count); virtual void
    // init_descriptors();
