...
void main() {
    ...
    VertexAttribute v0 =
        AttribsArray[nonuniformEXT(gl_InstanceCustomIndexEXT)].VertexAttribs[int(face.x)];
    VertexAttribute v1 =
        AttribsArray[nonuniformEXT(gl_InstanceCustomIndexEXT)].VertexAttribs[int(face.y)];
    VertexAttribute v2 =
    ...
    // const vec3 normal = normalize(cross(v0.normal.xyz - v1.normal.xyz, v0.normal.xyz -
    // v2.normal.xyz)); // just face normal
